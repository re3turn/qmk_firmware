...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
      ...
      KC_LSFT, KC_Z,    KC_X,    KC_C, KC_V,     KC_B,     TD_LBRC,  TD_RBRC,  KC_N,     KC_M,   KC_COMM, KC_DOT,  KC_SLSH,  KC_MINS, \
  ...
  [_COLEMAK] = LAYOUT( \
      ...
      KC_LSFT, KC_Z,    KC_X,    KC_C, KC_V,     KC_B,     TD_LBRC,  TD_RBRC,  KC_K,     KC_M,   KC_COMM, KC_DOT,  KC_SLSH,  KC_MINS, \
      KC_LCTL, KC_LGUI, KC_LALT, KANA, CTLT_ESC, LTLO_SPC, SFTT_TAB, KC_BSPC,  LTRA_ENT, KC_DEL, GUI_TAB, KC_RALT, LTAD_GUI, KC_BSLS \
      ),
  ...
  [_EUCALYN] = LAYOUT( \
      ...
      KC_LSFT, KC_Z,    KC_X,    KC_C,   KC_V,     KC_W,     TD_LBRC,  TD_RBRC,  KC_B,     KC_H,   KC_J,    KC_L,    TD_SCLN,  KC_MINS, \
      KC_LCTL, KC_LGUI, KC_LALT, KANA,   CTLT_ESC, LTLO_SPC, SFTT_TAB, KC_BSPC,  LTRA_ENT, KC_DEL, GUI_TAB, KC_RALT, LTAD_GUI, KC_BSLS \
      ),
  ...
  [_LOWER] = LAYOUT( \
      ...
      _______, _______, _______, _______, _______, _______,                   _______, _______, _______, KC_LCBR, KC_RCBR, KC_PLUS, \
      _______, _______, _______, _______, _______, _______, KC_LABK, KC_RABK, _______, _______, _______, TD_LBRC, TD_RBRC, _______, \
  ...
  [_RAISE] = LAYOUT( \
      KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,                   KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_UNDS, \
      KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                      KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, \
      _______, KC_PSCR, KC_PGUP, KC_HOME, KC_END,  KC_PGDN,                   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_F11,  KC_F12,  \
  ...
  [_ADJUST] =  LAYOUT( \
      ...
      _______, _______, OLEDTOG, AU_ON,   AU_OFF,  AG_SWAP,                   AG_NORM, QWERTY,  COLEMAK, EUCALYN, _______, _______, \
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
    ...
    case OLEDTOG:
        ...
        if (record->event.pressed) {
          if (OLED_TOG_STATUS) {
            OLED_TOG_STATUS = false;
            iota_gfx_off();
          } else {
            OLED_TOG_STATUS = true;
            iota_gfx_flush();
          }
        }
      #endif
