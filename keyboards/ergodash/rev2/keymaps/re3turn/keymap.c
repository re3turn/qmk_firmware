...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
  [_QWERTY] = LAYOUT( \
    GUI_SPC, KC_1,    KC_2,    KC_3,    KC_4, KC_5,     KC_LPRN,                        KC_RPRN, KC_6,     KC_7, KC_8,    KC_9,    KC_0,     KC_PSCR, \
    ...
    KC_LCTL, KC_LGUI, KC_LALT, CTLT_ESC,      LTLO_SPC, SFTT_TAB, XXXXXXX,     XXXXXXX, KC_BSPC, LTRA_ENT,       KC_DEL,  GUI_TAB, LTAD_GUI, KC_LALT \
  ),
  ...
  [_LOWER] = LAYOUT(
    ...
    _______, _______, _______, KC_PGUP, KC_HOME, _______, _______,                       _______, _______, _______, KC_UP,   _______, _______, _______, \
    _______, _______, _______, KC_PGDN, KC_END,  _______, _______,                       _______, _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, \
    _______, _______, _______, _______, _______, _______, _______,                       _______, _______, _______, _______, _______, _______, _______, \
    _______, _______, _______, _______,          _______, _______, _______,     _______, _______, _______,          _______, _______, _______, _______ \
  ),
  ...
  [_RAISE] = LAYOUT(
    ...
    _______, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_LCBR,                        KC_RCBR, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_PLUS, \
